...
- material palette, atlas dimensions, texels per Blockbench unit, emissive regions, and texture tier;
...
Texture: {ATLAS} atlas dimensions, {DENSITY} texels per Blockbench unit, nearest-neighbor pixel texture, {TEXTURE_TIER}; use deliberate pixel clusters, readable material separation, edge highlights, recess shadows, and controlled wear at that native density.

...
```json
{
  ...
  "animations": [],
  "animation_system": {
    "path": "animation-system.json",
    "status": "provisional | approved",
    "rig_signature": "stable rig contract signature",
    "handoff": {
      "path": "animation-handoff.json",
      "project_id": "same as model identity",
      "asset_id": "same as model identity",
      "asset_version": "input version",
      "model_sha256": "source model sha256",
      "writer_skill": "fjzm-animation",
      "single_writer": true,
      "validation_status": "pending | passed | failed",
      "result_path": "animation-result.json | null"
    }
  },
  "damage_system": {
    "destructible": true,

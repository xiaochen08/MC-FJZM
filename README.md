...
- 主 Skill 的第 1 问固定为 Minecraft Java 版本，第 2 问固定为 Mod 类型/加载器；
- 两个问题必须分成两轮，不得夹入项目路线、盘符、Java、模型、GUI 或生图问题；
- 用户直接说“1.20.1 Forge”只会锁定需求，不会自动创建 Mod、下载依赖、安装软件或控制应用；
- 用户说明“只是演示/举例”时，内容只作为对话上下文，不进入生产状态；
- 创建工程仍需后续单独选择项目路线，并给出明确的创建批准。

[查看 v5.2.1 完整更新内容](CHANGELOG.md#521---2026-07-22)
